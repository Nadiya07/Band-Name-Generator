...
app.post("/submit", (req, res) => {
  ...
  const adjectivee = adj[Math.floor(Math.random()* adj.length)];
  const  nounn = noun[Math.floor(Math.random()* noun.length)];
  ...
  res.render("index.ejs" , {adjective : adjectivee , noun : nounn})
});
